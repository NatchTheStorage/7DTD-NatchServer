Provides the following general improvements and cheats to the game:
	Blocks
		...
		Increased the fuel value for wood logs
		Increased Max Damage for some terran blocks
		Increased Max Damage for motion sensors and electrical relays
		Increased Max Damage for corrugated Metal Sheet and metal Rivet Sheet
	Entity classes
	...
	Items
		...
		Remove recoil all guns (bows and turrets not effected)
	...
	Recipes
		...
		Create Acid
		Add Recipe to create Ammo from Bundles (create the bundles required to support this)
		Add Recipe to create Pallets of Forged Iron and Steel Bars 
		Reduced the amount of raw meat required in an effort to make the recipes more balanced
